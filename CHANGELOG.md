...
- Adds a keyboard-accessible right-edge Markdown document map with paragraph progress, h1-h6 hierarchy, click navigation, responsive comments-panel coexistence, dark mode, and reduced-motion support.
